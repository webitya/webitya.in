...
import { Add, Edit, Delete, Search, Person, Email, School, Block, CheckCircle, Download } from "@mui/icons-material"
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">Manage all users and their course access</p>
          </div>
                ...
                <tr key={user._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {user.isActive ? <Block className="text-sm" /> : <CheckCircle className="text-sm" />}
                      </button>
                      <button
